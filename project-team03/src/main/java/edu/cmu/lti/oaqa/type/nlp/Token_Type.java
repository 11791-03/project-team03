...
public class Token_Type extends Annotation_Type {
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.oaqa.type.nlp.Token");
  ...
  public int getArguments(int addr, int i) {
    ...
    if (lowLevelTypeChecks)
      return ll_cas
              .ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_arguments), i, true);
  ...
  public String getArgumentLabels(int addr, int i) {
    ...
    if (lowLevelTypeChecks)
      return ll_cas
              .ll_getStringArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_argumentLabels), i,
                      true);
  ...
  public Token_Type(JCas jcas, Type casType) {
    ...
    casFeat_arguments = jcas
            .getRequiredFeatureDE(casType, "arguments", "uima.cas.FSArray", featOkTst);
    casFeatCode_arguments = (null == casFeat_arguments) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_arguments).getCode();

    casFeat_argumentLabels = jcas
            .getRequiredFeatureDE(casType, "argumentLabels", "uima.cas.StringArray", featOkTst);
    casFeatCode_argumentLabels = (null == casFeat_argumentLabels) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_argumentLabels).getCode();

    casFeat_parse = jcas
            .getRequiredFeatureDE(casType, "parse", "edu.cmu.lti.oaqa.type.nlp.Token", featOkTst);
    casFeatCode_parse = (null == casFeat_parse) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_parse).getCode();

    casFeat_semanticType = jcas
            .getRequiredFeatureDE(casType, "semanticType", "uima.cas.String", featOkTst);
    casFeatCode_semanticType = (null == casFeat_semanticType) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_semanticType).getCode();

    casFeat_partOfSpeech = jcas
            .getRequiredFeatureDE(casType, "partOfSpeech", "uima.cas.String", featOkTst);
    casFeatCode_partOfSpeech = (null == casFeat_partOfSpeech) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_partOfSpeech).getCode();

    casFeat_lemmaForm = jcas
            .getRequiredFeatureDE(casType, "lemmaForm", "uima.cas.String", featOkTst);
    casFeatCode_lemmaForm = (null == casFeat_lemmaForm) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_lemmaForm).getCode();

    casFeat_isMainReference = jcas
            .getRequiredFeatureDE(casType, "isMainReference", "uima.cas.Boolean", featOkTst);
    casFeatCode_isMainReference = (null == casFeat_isMainReference) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_isMainReference).getCode();

    casFeat_isVariable = jcas
            .getRequiredFeatureDE(casType, "isVariable", "uima.cas.Boolean", featOkTst);
    casFeatCode_isVariable = (null == casFeat_isVariable) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_isVariable).getCode();

    casFeat_determiner = jcas
            .getRequiredFeatureDE(casType, "determiner", "uima.cas.String", featOkTst);
    casFeatCode_determiner = (null == casFeat_determiner) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_determiner).getCode();
