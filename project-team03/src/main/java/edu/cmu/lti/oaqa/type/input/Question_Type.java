...
public class Question_Type extends Annotation_Type {
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.oaqa.type.input.Question");
  ...
  public Question_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_id = (null == casFeat_id) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_id).getCode();

    casFeat_source = jcas.getRequiredFeatureDE(casType, "source", "uima.cas.String", featOkTst);
    casFeatCode_source = (null == casFeat_source) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_source).getCode();

    casFeat_questionType = jcas.getRequiredFeatureDE(casType, "questionType",
            "edu.cmu.lti.oaqa.type.input.QuestionType", featOkTst);
    casFeatCode_questionType = (null == casFeat_questionType) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_questionType).getCode();
