...
public class AtomicQueryConcept_Type extends QueryConcept_Type {
          ...
          new FSGenerator() {
            public FeatureStructure createFS(int addr, CASImpl cas) {
              if (AtomicQueryConcept_Type.this.useExistingInstance) {
                ...
                return new AtomicQueryConcept(addr, AtomicQueryConcept_Type.this);
            }
          };
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.oaqa.type.retrieval.AtomicQueryConcept");
  ...
  public AtomicQueryConcept_Type(JCas jcas, Type casType) {
    ...
    casFeat_originalText = jcas
            .getRequiredFeatureDE(casType, "originalText", "uima.cas.String", featOkTst);
    casFeatCode_originalText = (null == casFeat_originalText) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_originalText).getCode();
