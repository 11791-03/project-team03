...
public class ComplexQueryConcept_Type extends QueryConcept_Type {
          ...
          new FSGenerator() {
            public FeatureStructure createFS(int addr, CASImpl cas) {
              if (ComplexQueryConcept_Type.this.useExistingInstance) {
                ...
                return new ComplexQueryConcept(addr, ComplexQueryConcept_Type.this);
            }
          };
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.oaqa.type.retrieval.ComplexQueryConcept");
  ...
  public ComplexQueryConcept_Type(JCas jcas, Type casType) {
    ...
    casFeat_operator = jcas.getRequiredFeatureDE(casType, "operator",
            "edu.cmu.lti.oaqa.type.retrieval.QueryOperator", featOkTst);
    casFeatCode_operator = (null == casFeat_operator) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_operator).getCode();

    casFeat_operatorArgs = jcas
            .getRequiredFeatureDE(casType, "operatorArgs", "uima.cas.FSList", featOkTst);
    casFeatCode_operatorArgs = (null == casFeat_operatorArgs) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_operatorArgs).getCode();
