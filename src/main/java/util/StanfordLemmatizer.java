 ...
 * <p/>
 * <p/>
 * It is called a stemmer, but, in fact, the Stanford stemmer seems to be a lemmatizer.
 */
...
public class StanfordLemmatizer {
  ...
  /**
   * Split the text into token (assuming tokens are separated by whitespaces), then stem each token
   * separately.
   */
