...
public class TrainingFactoidQuestion extends TrainingQuestion {

  @SerializedName("exact_answer")
  private List<String> exactAnswer;

  protected TrainingFactoidQuestion(String id, String body, QuestionType type,
          List<String> documents, List<Snippet> snippets, List<String> concepts,
          List<Triple> triples, List<String> idealAnswer, List<String> exactAnswer) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    TrainingFactoidQuestion other = (TrainingFactoidQuestion) obj;
    if (exactAnswer == null) {
