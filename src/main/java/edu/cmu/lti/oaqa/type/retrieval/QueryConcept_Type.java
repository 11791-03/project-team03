...
public class QueryConcept_Type extends TOP_Type {
          ...
          new FSGenerator() {
            public FeatureStructure createFS(int addr, CASImpl cas) {
              if (QueryConcept_Type.this.useExistingInstance) {
                ...
                return new QueryConcept(addr, QueryConcept_Type.this);
            }
          };
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.oaqa.type.retrieval.QueryConcept");
  ...
  public QueryConcept_Type(JCas jcas, Type casType) {
    ...
    casFeat_namedEntityTypes = jcas
            .getRequiredFeatureDE(casType, "namedEntityTypes", "uima.cas.StringList", featOkTst);
    casFeatCode_namedEntityTypes = (null == casFeat_namedEntityTypes) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_namedEntityTypes).getCode();

    casFeat_conceptType = jcas.getRequiredFeatureDE(casType, "conceptType",
            "edu.cmu.lti.oaqa.type.retrieval.ConceptType", featOkTst);
    casFeatCode_conceptType = (null == casFeat_conceptType) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_conceptType).getCode();
