...
public class Summary_Type extends TOP_Type {
          ...
          new FSGenerator() {
            public FeatureStructure createFS(int addr, CASImpl cas) {
              if (Summary_Type.this.useExistingInstance) {
                ...
                return new Summary(addr, Summary_Type.this);
            }
          };
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.oaqa.type.answer.Summary");
  ...
  public Summary_Type(JCas jcas, Type casType) {
    ...
    casFeat_variants = jcas
            .getRequiredFeatureDE(casType, "variants", "uima.cas.StringList", featOkTst);
    casFeatCode_variants = (null == casFeat_variants) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_variants).getCode();
